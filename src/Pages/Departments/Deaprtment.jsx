...
<Swiper
  ...
  >
{(role==='ADMIN')?
    <SwiperSlide  onClick={()=>navigate('/admin/imageUpload',{state:{imageType:'DEPARTMENT'}})}  className=" transition ease-in-out delay-150   w-[350px] h-[350px] border-2 shadow-xl hover:shadow-none border-gray-500 rounded-md flex flex-col justify-end items-center" >
     ...
     }
{
 ...
 <div className='text-4xl mt-4 text-red font-bold edu-au-vic-wa-nt-guides-font1'> Sorry No Image Present!!!!👏👏👏👏</div>
 </div>
 )
