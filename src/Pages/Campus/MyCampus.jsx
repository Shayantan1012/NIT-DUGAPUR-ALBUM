...
<Swiper
      ...
      >
{(role==='ADMIN')?
    <SwiperSlide  onClick={()=>navigate('/admin/imageUpload',{state:{imageType:'CAMPUS'}})}  className=" transition ease-in-out delay-150   w-[350px] h-[350px] border-2 shadow-xl hover:shadow-none border-gray-500 rounded-md flex flex-col justify-end items-center" >
